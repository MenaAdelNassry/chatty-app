import { passwordObject } from '@auth/schemes/password';
...
const changePasswordSchema: ObjectSchema = Joi.object().keys({
  currentPassword: passwordObject,
...
const deactivateSchema: ObjectSchema = Joi.object().keys({
...
export { basicInfoSchema, socialLinksSchema, changePasswordSchema, notificationSettingsSchema, deactivateSchema };
